...
# FIXME: currently, creating devices is not possible - as per the terraform providers, the device should be imported first and then
# adopted.
...
# FIXME: devices need to be deleted by MAC
nas_device = unifi.user.User("nas",
                             name="nas",
                             mac="2c:cc:66:55:33:33",
                             note="NAS",
                             fixed_ip="192.168.2.111",
                             network_id=personal_devices_network.id)

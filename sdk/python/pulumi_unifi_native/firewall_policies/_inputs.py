...
__all__ = [
    'FirewallPolicyDestinationDtoArgs',
    'FirewallPolicyDestinationDtoArgsDict',
    'FirewallPolicyScheduleDtoArgs',
    'FirewallPolicyScheduleDtoArgsDict',
    'FirewallPolicySourceDtoArgs',
    'FirewallPolicySourceDtoArgsDict',
]

MYPY = False

if not MYPY:
    class FirewallPolicyDestinationDtoArgsDict(TypedDict):
        matching_target: pulumi.Input['FirewallPolicyDestinationDtoMatchingTarget']
        port_matching_type: pulumi.Input['FirewallPolicyDestinationDtoPortMatchingType']
        zone_id: pulumi.Input[builtins.str]
        match_opposite_ports: NotRequired[pulumi.Input[builtins.bool]]
        matching_target_type: NotRequired[pulumi.Input['FirewallPolicyDestinationDtoMatchingTargetType']]
        port: NotRequired[pulumi.Input[builtins.str]]
        port_group_id: NotRequired[pulumi.Input[builtins.str]]
elif False:
    FirewallPolicyDestinationDtoArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class FirewallPolicyDestinationDtoArgs:
    def __init__(__self__, *,
                 matching_target: pulumi.Input['FirewallPolicyDestinationDtoMatchingTarget'],
                 port_matching_type: pulumi.Input['FirewallPolicyDestinationDtoPortMatchingType'],
                 zone_id: pulumi.Input[builtins.str],
                 match_opposite_ports: Optional[pulumi.Input[builtins.bool]] = None,
                 matching_target_type: Optional[pulumi.Input['FirewallPolicyDestinationDtoMatchingTargetType']] = None,
    ...
    def matching_target(self) -> pulumi.Input['FirewallPolicyDestinationDtoMatchingTarget']:
        return pulumi.get(self, "matching_target")

    @matching_target.setter
    def matching_target(self, value: pulumi.Input['FirewallPolicyDestinationDtoMatchingTarget']):
        pulumi.set(self, "matching_target", value)

    @property
    @pulumi.getter(name="portMatchingType")
    def port_matching_type(self) -> pulumi.Input['FirewallPolicyDestinationDtoPortMatchingType']:
        return pulumi.get(self, "port_matching_type")

    @port_matching_type.setter
    def port_matching_type(self, value: pulumi.Input['FirewallPolicyDestinationDtoPortMatchingType']):
    ...
    def match_opposite_ports(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "match_opposite_ports")

    @match_opposite_ports.setter
    def match_opposite_ports(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "match_opposite_ports", value)

    @property
    @pulumi.getter(name="matchingTargetType")
    def matching_target_type(self) -> Optional[pulumi.Input['FirewallPolicyDestinationDtoMatchingTargetType']]:
        return pulumi.get(self, "matching_target_type")

    @matching_target_type.setter
    def matching_target_type(self, value: Optional[pulumi.Input['FirewallPolicyDestinationDtoMatchingTargetType']]):
...
if not MYPY:
    class FirewallPolicySourceDtoArgsDict(TypedDict):
        matching_target: pulumi.Input['FirewallPolicySourceDtoMatchingTarget']
        port_matching_type: pulumi.Input['FirewallPolicySourceDtoPortMatchingType']
        zone_id: pulumi.Input[builtins.str]
        match_opposite_ports: NotRequired[pulumi.Input[builtins.bool]]
        matching_target_type: NotRequired[pulumi.Input['FirewallPolicySourceDtoMatchingTargetType']]
        port: NotRequired[pulumi.Input[builtins.str]]
        port_group_id: NotRequired[pulumi.Input[builtins.str]]
elif False:
    FirewallPolicySourceDtoArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class FirewallPolicySourceDtoArgs:
    def __init__(__self__, *,
                 matching_target: pulumi.Input['FirewallPolicySourceDtoMatchingTarget'],
                 port_matching_type: pulumi.Input['FirewallPolicySourceDtoPortMatchingType'],
                 zone_id: pulumi.Input[builtins.str],
                 match_opposite_ports: Optional[pulumi.Input[builtins.bool]] = None,
                 matching_target_type: Optional[pulumi.Input['FirewallPolicySourceDtoMatchingTargetType']] = None,
                 port: Optional[pulumi.Input[builtins.str]] = None,
                 port_group_id: Optional[pulumi.Input[builtins.str]] = None):
        pulumi.set(__self__, "matching_target", matching_target)
        pulumi.set(__self__, "port_matching_type", port_matching_type)
    ...
    @property
    @pulumi.getter(name="matchingTarget")
    def matching_target(self) -> pulumi.Input['FirewallPolicySourceDtoMatchingTarget']:
        return pulumi.get(self, "matching_target")

    @matching_target.setter
    def matching_target(self, value: pulumi.Input['FirewallPolicySourceDtoMatchingTarget']):
        pulumi.set(self, "matching_target", value)

    @property
    @pulumi.getter(name="portMatchingType")
    def port_matching_type(self) -> pulumi.Input['FirewallPolicySourceDtoPortMatchingType']:
        return pulumi.get(self, "port_matching_type")

    @port_matching_type.setter
    def port_matching_type(self, value: pulumi.Input['FirewallPolicySourceDtoPortMatchingType']):
        pulumi.set(self, "port_matching_type", value)
    ...
    @property
    @pulumi.getter(name="matchingTargetType")
    def matching_target_type(self) -> Optional[pulumi.Input['FirewallPolicySourceDtoMatchingTargetType']]:
        return pulumi.get(self, "matching_target_type")

    @matching_target_type.setter
    def matching_target_type(self, value: Optional[pulumi.Input['FirewallPolicySourceDtoMatchingTargetType']]):
        pulumi.set(self, "matching_target_type", value)

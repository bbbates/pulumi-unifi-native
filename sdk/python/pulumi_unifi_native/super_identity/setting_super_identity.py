...
__all__ = ['SettingSuperIdentityArgs', 'SettingSuperIdentity']

@pulumi.input_type
class SettingSuperIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a SettingSuperIdentity resource.
        """
        if id is not None:
...
@pulumi.type_token("unifi-native:super_identity:SettingSuperIdentity")
class SettingSuperIdentity(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a SettingSuperIdentity resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SettingSuperIdentityArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a SettingSuperIdentity resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param SettingSuperIdentityArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SettingSuperIdentityArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SettingSuperIdentityArgs.__new__(SettingSuperIdentityArgs)
        ...
        super(SettingSuperIdentity, __self__).__init__(
            'unifi-native:super_identity:SettingSuperIdentity',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SettingSuperIdentity':
        """
        Get an existing SettingSuperIdentity resource's state with the given name, id, and optional extra
        ...
        return SettingSuperIdentity(resource_name, opts=opts, __props__=__props__)

...
__all__ = ['SettingGlobalNatArgs', 'SettingGlobalNat']

@pulumi.input_type
class SettingGlobalNatArgs:
    def __init__(__self__, *,
                 ...
                 excluded_network_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 key: Optional[pulumi.Input[builtins.str]] = None,
                 mode: Optional[pulumi.Input[builtins.str]] = None,
                 site_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SettingGlobalNat resource.
        """
        if id is not None:
    ...
    def excluded_network_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "excluded_network_ids")

    @excluded_network_ids.setter
    def excluded_network_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
@pulumi.type_token("unifi-native:global_nat:SettingGlobalNat")
class SettingGlobalNat(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a SettingGlobalNat resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SettingGlobalNatArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a SettingGlobalNat resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param SettingGlobalNatArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SettingGlobalNatArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SettingGlobalNatArgs.__new__(SettingGlobalNatArgs)
        ...
        super(SettingGlobalNat, __self__).__init__(
            'unifi-native:global_nat:SettingGlobalNat',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SettingGlobalNat':
        """
        Get an existing SettingGlobalNat resource's state with the given name, id, and optional extra
        ...
        __props__.__dict__["excluded_network_ids"] = None
        __props__.__dict__["key"] = None
        __props__.__dict__["mode"] = None
        __props__.__dict__["site_id"] = None
        return SettingGlobalNat(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="excludedNetworkIds")
    def excluded_network_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        return pulumi.get(self, "excluded_network_ids")

...
@pulumi.output_type
class SettingElementAdopt(dict):
    def __init__(__self__, *,
                 ...
                 x_element_essid: Optional[builtins.str] = None,
                 x_element_psk: Optional[builtins.str] = None):
        if id is not None:
    ...
    def x_element_essid(self) -> Optional[builtins.str]:
        return pulumi.get(self, "x_element_essid")

    @property
    @pulumi.getter(name="xElementPsk")
    def x_element_psk(self) -> Optional[builtins.str]:

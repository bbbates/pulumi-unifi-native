...
__all__ = ['SettingSnmpArgs', 'SettingSnmp']

@pulumi.input_type
class SettingSnmpArgs:
    ...
    def enabled_v3(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "enabled_v3")

    @enabled_v3.setter
    def enabled_v3(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enabled_v3", value)
...
@pulumi.type_token("unifi-native:snmp:SettingSnmp")
class SettingSnmp(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a SettingSnmp resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SettingSnmpArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a SettingSnmp resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param SettingSnmpArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SettingSnmpArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SettingSnmpArgs.__new__(SettingSnmpArgs)
            ...
            __props__.__dict__["enabled_v3"] = enabled_v3
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SettingSnmp':
        """
        Get an existing SettingSnmp resource's state with the given name, id, and optional extra
        ...
        __props__.__dict__["enabled_v3"] = None
        __props__.__dict__["key"] = None
        __props__.__dict__["site_id"] = None
        __props__.__dict__["username"] = None
        __props__.__dict__["x_password"] = None
        return SettingSnmp(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="enabledV3")
    def enabled_v3(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "enabled_v3")

...
def get_dhcp_option(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('unifi-native:dhcpoption:getDHCPOption', __args__, opts=opts, typ=GetDHCPOptionResult).value

    return AwaitableGetDHCPOptionResult(
        data=pulumi.get(__ret__, 'data'),
        meta=pulumi.get(__ret__, 'meta'))
def get_dhcp_option_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('unifi-native:dhcpoption:getDHCPOption', __args__, opts=opts, typ=GetDHCPOptionResult)

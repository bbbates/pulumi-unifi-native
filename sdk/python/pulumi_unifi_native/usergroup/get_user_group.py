...
def get_user_group(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('unifi-native:usergroup:getUserGroup', __args__, opts=opts, typ=GetUserGroupResult).value
...
def get_user_group_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('unifi-native:usergroup:getUserGroup', __args__, opts=opts, typ=GetUserGroupResult)

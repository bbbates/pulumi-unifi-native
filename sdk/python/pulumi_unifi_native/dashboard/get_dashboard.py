...
def get_dashboard(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('unifi-native:dashboard:getDashboard', __args__, opts=opts, typ=GetDashboardResult).value
...
def get_dashboard_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('unifi-native:dashboard:getDashboard', __args__, opts=opts, typ=GetDashboardResult)

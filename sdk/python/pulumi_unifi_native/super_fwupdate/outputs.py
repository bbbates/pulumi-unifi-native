...
@pulumi.output_type
class SettingSuperFwupdate(dict):
    def __init__(__self__, *,
                 ...
                 controller_channel: Optional[builtins.str] = None,
                 firmware_channel: Optional[builtins.str] = None,
    ...
    def controller_channel(self) -> Optional[builtins.str]:
        return pulumi.get(self, "controller_channel")

    @property
    @pulumi.getter(name="firmwareChannel")
    def firmware_channel(self) -> Optional[builtins.str]:

...
__all__ = ['SettingTeleportArgs', 'SettingTeleport']

@pulumi.input_type
class SettingTeleportArgs:
...
@pulumi.type_token("unifi-native:teleport:SettingTeleport")
class SettingTeleport(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a SettingTeleport resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SettingTeleportArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a SettingTeleport resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param SettingTeleportArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SettingTeleportArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SettingTeleportArgs.__new__(SettingTeleportArgs)
        ...
        super(SettingTeleport, __self__).__init__(
            'unifi-native:teleport:SettingTeleport',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SettingTeleport':
        """
        ...
        return SettingTeleport(resource_name, opts=opts, __props__=__props__)

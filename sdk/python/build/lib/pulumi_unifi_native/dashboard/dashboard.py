...
class DashboardArgs:
    def __init__(__self__, *,
                 ...
                 controller_version: Optional[pulumi.Input[builtins.str]] = None,
                 desc: Optional[pulumi.Input[builtins.str]] = None,
                 is_public: Optional[pulumi.Input[builtins.bool]] = None,
                 modules: Optional[pulumi.Input[Sequence[pulumi.Input['DashboardModulesArgs']]]] = None,
    ...
    def controller_version(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "controller_version")

    @controller_version.setter
    def controller_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def modules(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DashboardModulesArgs']]]]:
        return pulumi.get(self, "modules")

    @modules.setter
    def modules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DashboardModulesArgs']]]]):
...
@pulumi.type_token("unifi-native:dashboard:Dashboard")
class Dashboard(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 desc: Optional[pulumi.Input[builtins.str]] = None,
                 is_public: Optional[pulumi.Input[builtins.bool]] = None,
                 modules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DashboardModulesArgs', 'DashboardModulesArgsDict']]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 site_id: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["controller_version"] = controller_version
        ...
        super(Dashboard, __self__).__init__(
            'unifi-native:dashboard:Dashboard',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__["controller_version"] = None
        __props__.__dict__["desc"] = None
    ...
    @property
    @pulumi.getter(name="controllerVersion")
    def controller_version(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "controller_version")
    ...
    @property
    @pulumi.getter
    def modules(self) -> pulumi.Output[Optional[Sequence['outputs.DashboardModules']]]:
        return pulumi.get(self, "modules")

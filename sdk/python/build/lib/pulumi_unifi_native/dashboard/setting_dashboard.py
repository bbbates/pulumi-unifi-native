...
__all__ = ['SettingDashboardArgs', 'SettingDashboard']

@pulumi.input_type
class SettingDashboardArgs:
    def __init__(__self__, *,
                 ...
                 layout_preference: Optional[pulumi.Input[builtins.str]] = None,
                 site_id: Optional[pulumi.Input[builtins.str]] = None,
                 widgets: Optional[pulumi.Input[Sequence[pulumi.Input['SettingDashboardWidgetsArgs']]]] = None):
        """
        The set of arguments for constructing a SettingDashboard resource.
        """
        if id is not None:
    ...
    def layout_preference(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "layout_preference")

    @layout_preference.setter
    def layout_preference(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "layout_preference", value)
    ...
    @property
    @pulumi.getter
    def widgets(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['SettingDashboardWidgetsArgs']]]]:
        return pulumi.get(self, "widgets")

    @widgets.setter
    def widgets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['SettingDashboardWidgetsArgs']]]]):
        pulumi.set(self, "widgets", value)


@pulumi.type_token("unifi-native:dashboard:SettingDashboard")
class SettingDashboard(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 layout_preference: Optional[pulumi.Input[builtins.str]] = None,
                 site_id: Optional[pulumi.Input[builtins.str]] = None,
                 widgets: Optional[pulumi.Input[Sequence[pulumi.Input[Union['SettingDashboardWidgetsArgs', 'SettingDashboardWidgetsArgsDict']]]]] = None,
                 __props__=None):
        """
        Create a SettingDashboard resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SettingDashboardArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a SettingDashboard resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param SettingDashboardArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SettingDashboardArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SettingDashboardArgs.__new__(SettingDashboardArgs)
            ...
            __props__.__dict__["layout_preference"] = layout_preference
            __props__.__dict__["site_id"] = site_id
            __props__.__dict__["widgets"] = widgets
        super(SettingDashboard, __self__).__init__(
            'unifi-native:dashboard:SettingDashboard',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SettingDashboard':
        """
        Get an existing SettingDashboard resource's state with the given name, id, and optional extra
        ...
        __props__.__dict__["layout_preference"] = None
        __props__.__dict__["site_id"] = None
        __props__.__dict__["widgets"] = None
        return SettingDashboard(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="layoutPreference")
    def layout_preference(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "layout_preference")
    ...
    @property
    @pulumi.getter
    def widgets(self) -> pulumi.Output[Optional[Sequence['outputs.SettingDashboardWidgets']]]:
        return pulumi.get(self, "widgets")

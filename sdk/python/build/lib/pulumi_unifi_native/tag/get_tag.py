...
def get_tag(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('unifi-native:tag:getTag', __args__, opts=opts, typ=GetTagResult).value
...
def get_tag_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('unifi-native:tag:getTag', __args__, opts=opts, typ=GetTagResult)

...
class ScheduleTask(dict):
    def __init__(__self__, *,
                 ...
                 execute_only_once: Optional[builtins.bool] = None,
                 name: Optional[builtins.str] = None,
                 site_id: Optional[builtins.str] = None,
                 upgrade_targets: Optional[Sequence['outputs.ScheduleTaskUpgradeTargets']] = None):
        if id is not None:
    ...
    def execute_only_once(self) -> Optional[builtins.bool]:
    ...
    def upgrade_targets(self) -> Optional[Sequence['outputs.ScheduleTaskUpgradeTargets']]:
        return pulumi.get(self, "upgrade_targets")


@pulumi.output_type
class ScheduleTaskUpgradeTargets(dict):
    def __init__(__self__, *,

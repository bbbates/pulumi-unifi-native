...
__all__ = ['MediaFileArgs', 'MediaFile']
...
class MediaFileArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a MediaFile resource.
        """
        if id is not None:
...
@pulumi.type_token("unifi-native:mediafile:MediaFile")
class MediaFile(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a MediaFile resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[MediaFileArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a MediaFile resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param MediaFileArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MediaFileArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MediaFileArgs.__new__(MediaFileArgs)
        ...
        super(MediaFile, __self__).__init__(
            'unifi-native:mediafile:MediaFile',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'MediaFile':
        """
        Get an existing MediaFile resource's state with the given name, id, and optional extra
        ...
        return MediaFile(resource_name, opts=opts, __props__=__props__)

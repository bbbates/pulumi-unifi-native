...
__all__ = ['SettingSuperEventArgs', 'SettingSuperEvent']

@pulumi.input_type
class SettingSuperEventArgs:
    def __init__(__self__, *,
                 id: Optional[pulumi.Input[builtins.str]] = None,
                 ignored: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        The set of arguments for constructing a SettingSuperEvent resource.
        """
        if id is not None:
    ...
    @property
    @pulumi.getter(name="Ignored")
    def ignored(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "ignored")

    @ignored.setter
    def ignored(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("unifi-native:super_events:SettingSuperEvent")
class SettingSuperEvent(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a SettingSuperEvent resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SettingSuperEventArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a SettingSuperEvent resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param SettingSuperEventArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SettingSuperEventArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SettingSuperEventArgs.__new__(SettingSuperEventArgs)
        ...
        super(SettingSuperEvent, __self__).__init__(
            'unifi-native:super_events:SettingSuperEvent',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SettingSuperEvent':
        """
        Get an existing SettingSuperEvent resource's state with the given name, id, and optional extra
        ...
        __props__.__dict__["ignored"] = None
        ...
        return SettingSuperEvent(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="Ignored")
    def ignored(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "ignored")

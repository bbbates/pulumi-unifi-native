...
__all__ = ['WLANGroupArgs', 'WLANGroup']
...
class WLANGroupArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a WLANGroup resource.
        """
        if id is not None:
...
@pulumi.type_token("unifi-native:wlangroup:WLANGroup")
class WLANGroup(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a WLANGroup resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[WLANGroupArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a WLANGroup resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param WLANGroupArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WLANGroupArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WLANGroupArgs.__new__(WLANGroupArgs)
        ...
        super(WLANGroup, __self__).__init__(
            'unifi-native:wlangroup:WLANGroup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'WLANGroup':
        """
        Get an existing WLANGroup resource's state with the given name, id, and optional extra
        ...
        return WLANGroup(resource_name, opts=opts, __props__=__props__)

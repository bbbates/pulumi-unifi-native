...
__all__ = ['SettingEvaluationScoreArgs', 'SettingEvaluationScore']

@pulumi.input_type
class SettingEvaluationScoreArgs:
    def __init__(__self__, *,
                 ...
                 dismissed_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 key: Optional[pulumi.Input[builtins.str]] = None,
                 site_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SettingEvaluationScore resource.
        """
        if id is not None:
        ...
        if dismissed_ids is not None:
            pulumi.set(__self__, "dismissed_ids", dismissed_ids)
        if key is not None:
    ...
    @property
    @pulumi.getter(name="dismissedIds")
    def dismissed_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "dismissed_ids")

    @dismissed_ids.setter
    def dismissed_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "dismissed_ids", value)
...
@pulumi.type_token("unifi-native:evaluation_score:SettingEvaluationScore")
class SettingEvaluationScore(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a SettingEvaluationScore resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SettingEvaluationScoreArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a SettingEvaluationScore resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param SettingEvaluationScoreArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SettingEvaluationScoreArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SettingEvaluationScoreArgs.__new__(SettingEvaluationScoreArgs)
            ...
            __props__.__dict__["dismissed_ids"] = dismissed_ids
            __props__.__dict__["key"] = key
            __props__.__dict__["site_id"] = site_id
        super(SettingEvaluationScore, __self__).__init__(
            'unifi-native:evaluation_score:SettingEvaluationScore',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SettingEvaluationScore':
        """
        Get an existing SettingEvaluationScore resource's state with the given name, id, and optional extra
        ...
        __props__.__dict__["dismissed_ids"] = None
        __props__.__dict__["key"] = None
        __props__.__dict__["site_id"] = None
        return SettingEvaluationScore(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="dismissedIds")
    def dismissed_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        return pulumi.get(self, "dismissed_ids")

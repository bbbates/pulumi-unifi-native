...
def get_user(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('unifi-native:user:getUser', __args__, opts=opts, typ=GetUserResult).value
...
def get_user_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('unifi-native:user:getUser', __args__, opts=opts, typ=GetUserResult)

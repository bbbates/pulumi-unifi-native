...
def get_firewall_rule(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('unifi-native:firewallrule:getFirewallRule', __args__, opts=opts, typ=GetFirewallRuleResult).value

    return AwaitableGetFirewallRuleResult(
        data=pulumi.get(__ret__, 'data'),
        meta=pulumi.get(__ret__, 'meta'))
def get_firewall_rule_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('unifi-native:firewallrule:getFirewallRule', __args__, opts=opts, typ=GetFirewallRuleResult)

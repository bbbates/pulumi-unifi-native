...
__all__ = ['BroadcastGroupArgs', 'BroadcastGroup']

@pulumi.input_type
class BroadcastGroupArgs:
    def __init__(__self__, *,
                 ...
                 member_table: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 site_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a BroadcastGroup resource.
        """
        if id is not None:
        ...
        if member_table is not None:
            pulumi.set(__self__, "member_table", member_table)
        if name is not None:
    ...
    @property
    @pulumi.getter(name="memberTable")
    def member_table(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "member_table")

    @member_table.setter
    def member_table(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "member_table", value)
...
@pulumi.type_token("unifi-native:broadcastgroup:BroadcastGroup")
class BroadcastGroup(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a BroadcastGroup resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[BroadcastGroupArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a BroadcastGroup resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param BroadcastGroupArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BroadcastGroupArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BroadcastGroupArgs.__new__(BroadcastGroupArgs)
            ...
            __props__.__dict__["member_table"] = member_table
            __props__.__dict__["name"] = name
            __props__.__dict__["site_id"] = site_id
        super(BroadcastGroup, __self__).__init__(
            'unifi-native:broadcastgroup:BroadcastGroup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'BroadcastGroup':
        """
        Get an existing BroadcastGroup resource's state with the given name, id, and optional extra
        ...
        __props__.__dict__["member_table"] = None
        __props__.__dict__["name"] = None
        __props__.__dict__["site_id"] = None
        return BroadcastGroup(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="memberTable")
    def member_table(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        return pulumi.get(self, "member_table")

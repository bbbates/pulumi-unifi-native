...
__all__ = ['SettingCountryArgs', 'SettingCountry']

@pulumi.input_type
class SettingCountryArgs:
...
@pulumi.type_token("unifi-native:country:SettingCountry")
class SettingCountry(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a SettingCountry resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SettingCountryArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a SettingCountry resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param SettingCountryArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SettingCountryArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SettingCountryArgs.__new__(SettingCountryArgs)
        ...
        super(SettingCountry, __self__).__init__(
            'unifi-native:country:SettingCountry',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SettingCountry':
        """
        ...
        return SettingCountry(resource_name, opts=opts, __props__=__props__)

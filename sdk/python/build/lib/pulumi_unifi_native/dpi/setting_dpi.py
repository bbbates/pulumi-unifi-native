...
__all__ = ['SettingDpiArgs', 'SettingDpi']

@pulumi.input_type
class SettingDpiArgs:
    def __init__(__self__, *,
                 ...
                 fingerprinting_enabled: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def fingerprinting_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "fingerprinting_enabled")

    @fingerprinting_enabled.setter
    def fingerprinting_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.type_token("unifi-native:dpi:SettingDpi")
class SettingDpi(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a SettingDpi resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SettingDpiArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a SettingDpi resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param SettingDpiArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SettingDpiArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SettingDpiArgs.__new__(SettingDpiArgs)
        ...
        super(SettingDpi, __self__).__init__(
            'unifi-native:dpi:SettingDpi',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SettingDpi':
        """
        ...
        __props__.__dict__["fingerprinting_enabled"] = None
        __props__.__dict__["key"] = None
        __props__.__dict__["site_id"] = None
        return SettingDpi(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="fingerprintingEnabled")
    def fingerprinting_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "fingerprinting_enabled")

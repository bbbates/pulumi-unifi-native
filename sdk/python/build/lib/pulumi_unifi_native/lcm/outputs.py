...
class SettingLcm(dict):
    def __init__(__self__, *,
                 ...
                 sync: Optional[builtins.bool] = None,
                 touch_event: Optional[builtins.bool] = None):
        if id is not None:
    ...
    @property
    @pulumi.getter
    def sync(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "sync")

    @property
    @pulumi.getter(name="touchEvent")
    def touch_event(self) -> Optional[builtins.bool]:

...
__all__ = ['SettingLocaleArgs', 'SettingLocale']

@pulumi.input_type
class SettingLocaleArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a SettingLocale resource.
        """
        if id is not None:
...
@pulumi.type_token("unifi-native:locale:SettingLocale")
class SettingLocale(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a SettingLocale resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SettingLocaleArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a SettingLocale resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param SettingLocaleArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SettingLocaleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SettingLocaleArgs.__new__(SettingLocaleArgs)
        ...
        super(SettingLocale, __self__).__init__(
            'unifi-native:locale:SettingLocale',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SettingLocale':
        """
        ...
        return SettingLocale(resource_name, opts=opts, __props__=__props__)

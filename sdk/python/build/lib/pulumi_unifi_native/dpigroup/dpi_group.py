...
class DpiGroupArgs:
    def __init__(__self__, *,
                 ...
                 dpiapp_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 site_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a DpiGroup resource.
        """
        if id is not None:
        ...
        if dpiapp_ids is not None:
            pulumi.set(__self__, "dpiapp_ids", dpiapp_ids)
    ...
    @property
    @pulumi.getter(name="dpiappIds")
    def dpiapp_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "dpiapp_ids")

    @dpiapp_ids.setter
    def dpiapp_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "dpiapp_ids", value)
...
@pulumi.type_token("unifi-native:dpigroup:DpiGroup")
class DpiGroup(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a DpiGroup resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[DpiGroupArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a DpiGroup resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param DpiGroupArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DpiGroupArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DpiGroupArgs.__new__(DpiGroupArgs)
            ...
            __props__.__dict__["dpiapp_ids"] = dpiapp_ids
            __props__.__dict__["enabled"] = enabled
            __props__.__dict__["name"] = name
            __props__.__dict__["site_id"] = site_id
        super(DpiGroup, __self__).__init__(
            'unifi-native:dpigroup:DpiGroup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'DpiGroup':
        """
        Get an existing DpiGroup resource's state with the given name, id, and optional extra
        ...
        __props__.__dict__["dpiapp_ids"] = None
        __props__.__dict__["enabled"] = None
        __props__.__dict__["name"] = None
        __props__.__dict__["site_id"] = None
        return DpiGroup(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="dpiappIds")
    def dpiapp_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        return pulumi.get(self, "dpiapp_ids")

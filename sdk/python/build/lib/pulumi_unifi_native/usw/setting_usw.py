...
__all__ = ['SettingUswArgs', 'SettingUsw']

@pulumi.input_type
class SettingUswArgs:
...
@pulumi.type_token("unifi-native:usw:SettingUsw")
class SettingUsw(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a SettingUsw resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SettingUswArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a SettingUsw resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param SettingUswArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SettingUswArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SettingUswArgs.__new__(SettingUswArgs)
        ...
        super(SettingUsw, __self__).__init__(
            'unifi-native:usw:SettingUsw',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SettingUsw':
        """
        ...
        return SettingUsw(resource_name, opts=opts, __props__=__props__)

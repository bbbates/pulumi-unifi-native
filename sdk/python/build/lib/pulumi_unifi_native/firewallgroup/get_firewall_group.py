...
def get_firewall_group(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('unifi-native:firewallgroup:getFirewallGroup', __args__, opts=opts, typ=GetFirewallGroupResult).value

    return AwaitableGetFirewallGroupResult(
        data=pulumi.get(__ret__, 'data'),
        meta=pulumi.get(__ret__, 'meta'))
def get_firewall_group_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('unifi-native:firewallgroup:getFirewallGroup', __args__, opts=opts, typ=GetFirewallGroupResult)

...
class FirewallGroupArgs:
    def __init__(__self__, *,
                 ...
                 group_members: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
    ...
    def group_members(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "group_members")

    @group_members.setter
    def group_members(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
@pulumi.type_token("unifi-native:firewallgroup:FirewallGroup")
class FirewallGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a FirewallGroup resource with the given unique name, props, and options.
    ...
    def _internal_init(__self__,
        ...
        super(FirewallGroup, __self__).__init__(
            'unifi-native:firewallgroup:FirewallGroup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'FirewallGroup':
        """
    ...
    @property
    @pulumi.getter(name="groupMembers")
    def group_members(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        return pulumi.get(self, "group_members")

...
__all__ = ['SettingSuperFwArgs', 'SettingSuperFw']

@pulumi.input_type
class SettingSuperFwArgs:
    def __init__(__self__, *,
                 ...
                 controller_channel: Optional[pulumi.Input[builtins.str]] = None,
                 firmware_channel: Optional[pulumi.Input[builtins.str]] = None,
                 key: Optional[pulumi.Input[builtins.str]] = None,
                 site_id: Optional[pulumi.Input[builtins.str]] = None,
                 sso_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a SettingSuperFw resource.
        """
        if id is not None:
        ...
        if controller_channel is not None:
            pulumi.set(__self__, "controller_channel", controller_channel)
        if firmware_channel is not None:
            pulumi.set(__self__, "firmware_channel", firmware_channel)
        if key is not None:
    ...
    @property
    @pulumi.getter(name="controllerChannel")
    def controller_channel(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "controller_channel")

    @controller_channel.setter
    def controller_channel(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "controller_channel", value)

    @property
    @pulumi.getter(name="firmwareChannel")
    def firmware_channel(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "firmware_channel")

    @firmware_channel.setter
    def firmware_channel(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "firmware_channel", value)
...
@pulumi.type_token("unifi-native:super_fwupdate:SettingSuperFw")
class SettingSuperFw(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a SettingSuperFw resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SettingSuperFwArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a SettingSuperFw resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param SettingSuperFwArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SettingSuperFwArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SettingSuperFwArgs.__new__(SettingSuperFwArgs)
            ...
            __props__.__dict__["controller_channel"] = controller_channel
            __props__.__dict__["firmware_channel"] = firmware_channel
            __props__.__dict__["key"] = key
            __props__.__dict__["site_id"] = site_id
            __props__.__dict__["sso_enabled"] = sso_enabled
        super(SettingSuperFw, __self__).__init__(
            'unifi-native:super_fwupdate:SettingSuperFw',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'SettingSuperFw':
        """
        Get an existing SettingSuperFw resource's state with the given name, id, and optional extra
        ...
        __props__.__dict__["controller_channel"] = None
        __props__.__dict__["firmware_channel"] = None
        __props__.__dict__["key"] = None
        __props__.__dict__["site_id"] = None
        __props__.__dict__["sso_enabled"] = None
        return SettingSuperFw(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="controllerChannel")
    def controller_channel(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "controller_channel")

    @property
    @pulumi.getter(name="firmwareChannel")
    def firmware_channel(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "firmware_channel")
    ...
    @property
    @pulumi.getter(name="ssoEnabled")
    def sso_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "sso_enabled")
